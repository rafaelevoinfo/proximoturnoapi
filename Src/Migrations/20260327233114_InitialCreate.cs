        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TEMPO_ESTIMADO_JOGO = table.Column<TimeSpan>(type: "time(6)", nullable: true),
                    VALOR_COMPRA = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DATA_COMPRA = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
